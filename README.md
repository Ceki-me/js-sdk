...
Chat between agent and browser provider goes through the relay server. Use the `ChatAPI` class (available via `session.relayChat`) to send/receive text and image messages, load history, and track typing indicators.
